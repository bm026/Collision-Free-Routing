...
\begin{enumerate}[leftmargin=*,labelindent=15pt,label=\bfseries 3.\arabic*] 
	...
	\item Allowances can be made for very large input programs (more than ten thousand lines of code), but they still must be fully executed by the emulation given sufficient time.
\end{enumerate}
...
dependent on availability of program compiler
