...
\noindent\textbf{Result}: The performance metrics provided by the emulation for both routing algorithms are shown below in table 1.\\
...
%This means that all of the routes in each permutation must pass through the outermost layer of switches, and are all the same length. Provided there are no collisions during network traversal 
...
\noindent\textbf{Result}: The performance metrics provided by the emulation for both routing algorithms are shown below in table 2.\\
...
\noindent\textbf{Result}: The performance metrics provided by the emulation for both routing algorithms are shown below in table 3.\\
...
\cline{2-4}
\begin{tabular}[c]{@{}c@{}}\ \\[8pt] \ \end{tabular}& \textbf{\begin{tabular}[c]{@{}c@{}}\ \ \ Packets\ \ \ \\ sent\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ Timesteps\ \\completed\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ \ Collisions\ \ \\ detected\end{tabular}} \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}} \ \\Routing algorithm\\ \ \end{tabular}}                                                                                 & 32000                                                           & 35391                                                                                 & 7416                                                                      \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Two-phase randomised\ \  \\ routing (avg. 10 runs)\end{tabular}} 
& \begin{tabular}[c]{@{}c@{}} \ \\32000\\ \ \end{tabular}                                                           
& 36921                                                                                 & 9472                                                                   \\ \hline
\end{tabular}
...
\noindent\textbf{7.1.4 \ \ Summary of results}
