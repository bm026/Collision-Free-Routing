...
\usepackage{listings}
\usepackage{color}
\definecolor{mygrey}{rgb}{0.975,0.975,0.975}
\definecolor{mydarkgrey}{rgb}{0.95,0.95,0.95}
...
\setcounter{page}{0}
\includepdf[pages={1}]{frontpage_shifted.pdf}
\includepdf[pages={1}]{declaration_shifted.pdf}
...
\cline{2-4}
\begin{tabular}[c]{@{}c@{}}\ \\[8pt] \ \end{tabular}& \textbf{\begin{tabular}[c]{@{}c@{}}\ \ \ Packets\ \ \ \\ sent\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ Timesteps\ \\completed\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ \ Collisions\ \ \\ detected\end{tabular}} \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}} \ \\Routing algorithm\\ \ \end{tabular}}                                                                                 & 32000                                                           & 36037                                                                                 & 0                                                                      \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Two-phase randomised\ \  \\ routing (avg. 10 runs)\end{tabular}} 
& \begin{tabular}[c]{@{}c@{}} \ \\32000\\ \ \end{tabular}                                                           
& 36576                                                                                 & 7691                                                                   \\ \hline
\end{tabular}
\caption[Comparing the performance of the developed routing algorithm and two-phase randomised routing for full permutations]{The performance metrics for both algorithms routing full permutations.}
\end{table}
...
\cline{2-4}
\begin{tabular}[c]{@{}c@{}}\ \\[8pt] \ \end{tabular}& \textbf{\begin{tabular}[c]{@{}c@{}}\ \ \ Packets\ \ \ \\ sent\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ Timesteps\ \\completed\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ \ Collisions\ \ \\ detected\end{tabular}} \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}} \ \\Routing algorithm\\ \ \end{tabular}}                                                                                 & 32000                                                           & 23789                                                                                 & 0                                                                      \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Two-phase randomised\ \  \\ routing (avg. 10 runs)\end{tabular}} 
& \begin{tabular}[c]{@{}c@{}} \ \\32000\\ \ \end{tabular}                                                           
& 36972                                                                                 & 9622                                                                   \\ \hline
\end{tabular}
\caption[Comparing the performance of the developed routing algorithm and two-phase randomised routing for regular permutations]{The performance metrics for both algorithms routing regular permutations.}
\end{table}
...
\cline{2-4}
\begin{tabular}[c]{@{}c@{}}\ \\[8pt] \ \end{tabular}& \textbf{\begin{tabular}[c]{@{}c@{}}\ \ \ Packets\ \ \ \\ sent\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ Timesteps\ \\completed\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ \ Collisions\ \ \\ detected\end{tabular}} \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}} \ \\Routing algorithm\\ \ \end{tabular}}                                                                                 & 32000                                                           & 36458                                                                                 & 7416                                                                      \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}}Two-phase randomised\ \  \\ routing (avg. 10 runs)\end{tabular}} 
& \begin{tabular}[c]{@{}c@{}} \ \\32000\\ \ \end{tabular}                                                           
& 36921                                                                                 & 9472                                                                   \\ \hline
\end{tabular}
\caption[Comparing the performance of the developed routing algorithm and two-phase randomised routing for irregular permutations]{The performance metrics for both algorithms routing irregular permutations.}
\end{table}
...
\cline{2-4}
\begin{tabular}[c]{@{}c@{}}\ \\[8pt] \ \end{tabular}& \textbf{\begin{tabular}[c]{@{}c@{}}\ \ \ Packets\ \ \ \\ sent\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ Timesteps\ \\completed\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}\ \ Collisions\ \ \\ detected\end{tabular}} \\ \hline
\multicolumn{1}{|l|}{\begin{tabular}[c]{@{}l@{}} \ \\Serial program\\ \ \end{tabular}}                                                                                 & \begin{tabular}[c]{@{}c@{}} \ \\0\\ \ \end{tabular}                                                                                                                      & 76115                                                                                 & 0                                                                      \\ \hline
\multicolumn{1}{|l|}{Parallel program \ \ \ \ \ \ } 
& \begin{tabular}[c]{@{}c@{}} \ \\1024\\ \ \end{tabular}                                                           
& 4907                                                                                 & 256                                                                   \\ \hline
\end{tabular}
\caption[Comparing the performance of a parallel program using multiple processors to an equivalent serial program using a single processor]{The performance metrics for execution of the serial and parallel programs.}
\end{table}
...
\addcontentsline{toc}{subsection}{8.1 \ \ Summary of achievements}
...
\addcontentsline{toc}{subsection}{8.2 \ \ Possible future developments}
\vspace{-1mm}
...
{\ttfamily{\$ ./run.sh < [input\_program\_file]}}
...
{\ttfamily{\$ vi network.h}}

\newpage
\noindent Once the header file is open, search for the line prefix:

{\ttfamily{unsigned int verbose =}}

\noindent To toggle between verbose and non-verbose modes, set this variable definition to {\ttfamily{true}} or {\ttfamily{false}} respectively. Once the variable is defined, save and close the header file and the output of the emulation has been changed.\\
...
{\ttfamily{unsigned int routing\_code =}}

\noindent To instruct the emulation to use the developed routing algorithm, set this variable definition to {\ttfamily{0}}, otherwise to instruct the emulation to use two-phase randomised routing, set this variable definition to {\ttfamily{1}}. Once the variable is defined, save and close the header file and the routing algorithm used by the emulation has been changed.
...
\addcontentsline{toc}{section}{Appendix C: Description of Input Program Syntax}
...
\addcontentsline{toc}{section}{Appendix D: Input Program Code Listings}
